...
export default function ContentPage() {
  ...
  const selectedPacket = useMemo(() => {
    if (!selectedIdea) {return packets[0] ?? null;}
    return packets.find((packet) => packet.source_run_id === selectedIdea.source_run_id) ?? packets[0] ?? null;
              ...
              {!selectedPacket ? (
                ...
                <>
                  <div>
                    ...
                    <div className="font-semibold">{selectedPacket.title}</div>
