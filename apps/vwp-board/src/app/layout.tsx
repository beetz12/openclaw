...
function TabBar() {
  return (
    <nav className="md:hidden fixed bottom-0 left-0 right-0 z-50 flex h-[var(--tab-bar-height)] items-center gap-1 overflow-x-auto overflow-y-hidden border-t border-[var(--color-border)] bg-[var(--color-surface)] px-2">
      <a
        href="/"
        className="flex shrink-0 flex-col items-center gap-1 px-3 py-2 text-xs font-medium text-[var(--color-text-secondary)]"
      >
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.5">
          <path d="M4 4h12a2 2 0 012 2v6a2 2 0 01-2 2H8l-4 3v-3a2 2 0 01-2-2V6a2 2 0 012-2z" />
        </svg>
